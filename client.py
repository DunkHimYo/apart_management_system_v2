...
class WebsocketClient():
    ...
    def __init__(self, url,  check_response=False, response_key="id", timeout=10):
        self._url = url
        ...
        self._websocket = self._loop.run_until_complete(websockets.connect(url, ping_interval=None))
